...
class DeviceMapperTestCase(TestCase):
    ...
    def setUp(self):
        self.prod_device = Device.objects.create(device="pe1.dc1", environment="prod", os_type="iosxr")
        self.prod_interface = DeviceInterface.objects.create(device=self.prod_device, interface="tengige0/0/0/0")
        self.lab_device = Device.objects.create(device="pe1.dc1-lab", environment="lab", os_type="iosxr")
    ...
    def test_device_creation(self):
        self.assertEquals(self.prod_device.device, "pe1.dc1")
        self.assertEquals(self.prod_device.environment, "prod")
        self.assertEquals(self.prod_device.os_type, "iosxr")
        self.assertEquals(self.lab_device.device, "pe1.dc1-lab")
